...
<span class="series-number">?§ ⋎</span> “If ‘ne’ is a negation, then ‘ne ne p’ must, if only it is understood in the appropriate way, be equivalent to p.” “If one takes ‘ne ne p’ as the negation of p, one must understand the doubling differently.” One would like to say: “‘Doubling’ _means_ something different then, _therefore_ it now yields a negation”, that is, that it now yields a negation is the consequence of its different meaning. “I now understand it as an intensification,” one would say. We put in place of the opinion the expression of the opinion. Direct your gaze to the expression of the opinion.
