...
If you are not clear about the role of logic in the concepts of color, start with the simple case of a yellowish red, for example. This exists; no one doubts it. How do I learn the use of the word “yellowish”? Through language-games of ordering, for example. Thus, I can learn, in agreement with others, to recognize yellowish & more yellowish reds, greens, browns, whites. In doing so, I take independent steps, as in arithmetic. One person might solve the task of finding a yellowish blue by means of a greenish blue, while another does not understand. What does this depend on? _I_ say that greenish blue contains _no_ yellow; if another says that it does contain yellow, who is right? How is this to be tested? Do the two differ only in their words? Will not one recognize a pure green that neither tends toward blue nor toward yellow? And what is the use of this? In which language-games can this be used? He will, in any case, be able to solve the task of separating green things that have _no_ yellowishness, & those that contain _no_ blue. In this, the dividing point ‘green’ will consist, which the other does not know.
...
And to whom can I describe what _we_ ordinary people can all learn? Even the understanding of the description already presupposes that one has learned something. How can I describe to someone how we use the word “tomorrow”? I can _teach_ this to a child; but that does not mean describing the use to him. But can I at least describe the practice of people who have a concept, e.g. ‘reddish-green’, that we do not have? – I can certainly not _teach_ this practice to anyone.
...
The impression of transparency is that something lies behind the medium. Complete uniformity of the visual image cannot therefore be transparent. Something white behind a colored transparent medium appears in the color of the medium, something black appears black. According to this rule, a black drawing on white paper should appear behind a white transparent medium as it would behind a colorless one. This is not a sentence of physics here, but this is how we interpret our visual experience. One could also say that it is a rule for the painter: “If you want to depict something white behind a transparent red, then you must paint it red.” If you paint it white, it will not look as if it is behind the red.
...
What looks brightly _aussieht_, does not look gray. Everything gray _sieht_ looks illuminated _aus_. However, the fact that something can ‘look brightly’, this is due to the distribution of the brightness in the field of vision, but there is also a ‘seeing something _als_ brightly’, one can, under certain circumstances, mistake reflected light for the light of a luminous body.
...
The question is: what kind must our visual image be if we are to call it that of a colored transparent medium? One could also ask: what must something look like in order for it to appear colored and transparent to us? This is not a question of physics, but it is connected with physical questions. What is the nature of our visual image, which we call that of a colored transparent medium?
...
In the film, as in a photograph, the face & hair do not appear _gray_; they give a perfectly natural impression. Food on a plate, on the other hand, often looks gray in the film & therefore unappetizing. But what does it mean to say that hair looks blond in a photograph? How does it manifest that it _looks_ that way & one does not simply _assume_ it based on its color? Which of our reactions leads us to say this? – Doesn't a head made of stone or plaster look white?
...
One might say: “Look at this color for a while.” However, one does not do this in order to _sehen_ more than one would have seen at first glance.
...
Could a “psychology” contain the sentence: “There are people who _sehen_”? Well, would that be wrong? – But to whom is something being communicated here? (And I don’t just mean: what is being communicated is already well known.)
...
Can one say that I have _observed_ that Andre & I can walk with our eyes open without bumping into anything, & that we can’t do it with our eyes closed?
